        ...
        if st.session_state.vis_mode == "🔥 Lämpökartta (Heatmap)":
            ...
            if not nodes.empty:
                ...
                if not sessions.empty:
                    ...
                    st.session_state.sql_query = f"SELECT x, y FROM main.gold_reitit WHERE node_id = '{st.session_state.selected_node}' AND full_session_id = '{st.session_state.selected_session}' ORDER BY aika"
