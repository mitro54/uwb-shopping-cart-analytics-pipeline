"""
ByteBuddies UWB Dashboard analytiikka sovelluksen schema agentti.

Schema agentti on vastuussa tietokannan rakenteen selvittämisestä ja tallentamisesta muistiin.
