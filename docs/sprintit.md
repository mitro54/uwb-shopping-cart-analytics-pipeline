...
#### Mikä toimi hyvin (Liked)
- Saatiin paljon aikaan ja saatiin hyvin asioita valmiiksi, jopa seuraavan sprintin hommia.
- Oli tuottavaa tehdä porukalla ja saatiin tosi hyvin yhdessä tehtyä asioita. Sprintti tuntui paljon enemmän tiimityöskentelyltä.
- Kommunikointia koodauksen suhteen oli paljon enemmän ja tuimme paljon enemmän toisiamme.
- Suunnittelu oli yhtä hyvä kuin toteutus.

#### Mitä opittiin (Learnt)
- Issuet olivat liian suuria.
- Loppuviikosta olisi voinut saada itse ainakin enemmän jotakin näkyvää aikaiseksi.
- Tehtäviä voisi ehkä jakaa vähän laajemmaltikin (monta polkua).
- Ratkaisut on hyvä tehdä tiimin kesken yhteisesti.

#### Mitä parannetaan (Lacked / Ensi sprinttiin)
- Lisätään vieläkin enemmän yhdessä tekemistä ja kiinnitetään huomiota siihen, että asiat pilkotaan tarpeeksi pieniksi osiksi.
- Määritellään issuet paremmin niin, että yksi issue vastaa "päivän" työtä.
- Lisätään committien määrää.
- Kommunikointia ei ole ikinä liikaa, jatketaan tiivistä kommunikaatiota tiimin kesken.
- Tehdään yhdessä ja pidetään hauskaa.
- Tahti on kova, pidetään se sellaisena, mutta siten että kaikki pysyvät kumminkin mukana.
...
* Gold-tason datan rikastaminen ja laadunvarmistus
* Visualisointiratkaisujen tutkiminen, toteutus ja hienosäätö
* Ominaisuuksien ja todellisen asiakasarvon kirkastaminen
