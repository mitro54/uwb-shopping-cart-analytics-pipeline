...
2. Luo DuckDB-tietokantaan taulun nimeltä `bronze_csv_data`.
...
- **Mallien muokkaus:** Jos haluat muuttaa datan käsittelyä, muokkaa tiedostoa: `models/bronze/bronze_csv_data.sql`.
